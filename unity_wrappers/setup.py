...
import unity_wrappers

VERSION = unity_wrappers.__version__
EXPECTED_TAG = unity_wrappers.__release_tag__
...
setup(
    ...
    author="Unity Technologies modified by Thales Pôle IA - labo RHS",
